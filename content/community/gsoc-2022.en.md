...
- [Dino](https://wiki.xmpp.org/web/Google_Summer_of_Code_2022#Dino): Dino is a modern open-source chat client for the desktop. It focuses on providing a clean and reliable Jabber/XMPP experience while having your 
privacy in mind.
- [Psi](https://wiki.xmpp.org/web/Google_Summer_of_Code_2022#Psi): An XMPP client for advanced users.
- [PGPainless](https://wiki.xmpp.org/web/Google_Summer_of_Code_2022#PGPainless): PGPainless is a Java OpenPGP library. While it is not strictly an XMPP related project, it has it has its origins in GSoC and the XMPP community, since it was created as a Summer of Code project in 2018.
