...
[Demo: ad-hoc commands and data forms in Mellium](https://www.youtube.com/watch?v=C2oyAfJeqno) - Sam Whited demos the new support for XEP-0050: Ad-Hoc Commands and XEP-0004: Data Forms in the Mellium XMPP library.
...
[Gajim Development News](https://gajim.org/post/2021-06-27-development-news-june/): This month brought some fixes for themes and spell checking. 
Development on the new Gajim version made a big step forward: file previews are working again and more important they're now a core integrated feature, they look even better while also being privacy respecting for those anonymous chats.
...
Blabber.IM XMPP service has been discontinued and has shut down its server. On June 25, the official blabber.im website reported that they were discontinuing support for their XMPP server.
...
[A Qt XMPP Bridge for Telegram based on QXmpp](https://invent.kde.org/lnj/qxbridge/)
