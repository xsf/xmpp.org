...
UWPX [v.0.33.0.0](https://github.com/UWPX/UWPX-Client/releases/tag/v.0.33.0.0) has been released. It inclues support for [XMPP Providers](https://invent.kde.org/melvo/xmpp-providers/-/tree/master) for auto complete and registration. Besides that, this release fixes a few bugs related to stream close and open message parsing.
![Screenshot 2021-07-01 071921](https://user-images.githubusercontent.com/11741404/124069653-cf8dc600-da3c-11eb-86b7-324cbc6ac26f.png)
