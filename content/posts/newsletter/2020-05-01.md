...
The XMPP library for Python 3.7+, [Slixmpp](https://lab.louiz.org/poezio/slixmpp), was updated to version 1.5.0, with minor releases 1.5.1 and 1.5.2. The [changelog]( https://lab.louiz.org/poezio/slixmpp/-/tags/slix-1.5.0) shows improvements of numerous XEPs and preliminary support for OMEMO.
