...
The python based XMPP automatic file sender [Errol has been updated to v2.0.1](https://blog.agayon.be/errol_update1.html) which modernizes its async i/o calls and adds more privacy. By moving from 'aionotify' to use the better maintained 'watchdog', Errol theoretically extends its support from Linux only to Windows, Mac OS X and FreeBSD.
