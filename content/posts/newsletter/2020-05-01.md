...
You have a project and write about it? Please consider to put your news or event in here, too!
If you can only spent a few minutes, that is already helping. We really would like to keep it as a community effort!

Tasks which needs to be done on a regular basis are for example:

- Aggregation of news in the XMPP universe
- Short formulation of news and events
- Summarize the monthly communication on extensions (XEP)
- Review of the draft
...
blabber.im has now [support for IPv6](https://blabber.im/blabber-im-ist-nun-ipv6-tauglich/) and they created an [invitation link which works for their server but also for every other ID](https://blabber.im/i-moved/). You can put that to you status in e.g. other chat clients you use.

jabber.org are performing a server mirgration to prosody. [Stay informed!](https://www.jabber.org/notices.html)
...
The python based XMPP automatic file sender [Errol has been updated to v2.0.1](https://blog.agayon.be/errol_update1.html) which modernizes its async i/o calls, adds more privacy and, in addition to Linux, theoretically extends its support to Windows, Mac OS X and FreeBSD by moving from 'aionotify' to use the better maintained 'watchdog'.
