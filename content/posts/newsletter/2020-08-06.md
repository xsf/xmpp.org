...
Kontalk for Android has released a [new version (4.4.0)](https://github.com/kontalk/androidclient/releases)! Apart from bugfixes and improvements it has now a dark theme, supports sharing to groups, media export to storage, media delete with messages, revamped settings, as well as Android 10 support.
...
Thanks to eta, emus, erszcz, Holger, kriztan, jerome-poisson, jonas', Licaon_Kter, peetah, vanitasvitae, wurstsalat, woj-tek, zash for their help in creating it!
