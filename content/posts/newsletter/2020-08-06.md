...
of bugfixes and improvements this month, mainly as a result of various users running the bridge and running
into errors. We also switched to using the Nix package manager to build our Docker images, resulting in more 
reproducible, faster builds! They getting closer to a stable 0.1 release, and the basic functionality is 
...
Please do pop by our MUC [whatsxmpp@conf.theta.eu.org](xmpp:whatsxmpp@conf.theta.eu.org?join) if you're interested 
