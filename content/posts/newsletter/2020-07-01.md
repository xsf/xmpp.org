...
JC Brand created an [XMPP job board](https://xmpp.work/)! This enables people to review job offers as well as advertise XMPP services. Please take a look, post your own offers and recommend it. XMPP works!
...
Daniel Gultsch and Holger Weiss had a [virtual talk on their A/V implementation](https://www.youtube.com/watch?v=v_riuu4XU6Q) in Conversation and describe the technical details. eta finalized the session with a second talk by defining love by this formula: Asterisk + XMPP = <3
...
Profanity released its version 0.9.0 which supports Last Message Correction (XEP-0308) and fixes various issues that can be found in their [blog post](https://profanity-im.github.io/blog/post/release-090/). After the new major release the bugfix releases [0.9.1](https://github.com/profanity-im/profanity/releases/tag/0.9.1), [0.9.2](https://github.com/profanity-im/profanity/releases/tag/0.9.2), [0.9.3](https://github.com/profanity-im/profanity/releases/tag/0.9.3) and [0.9.4](https://github.com/profanity-im/profanity/releases/tag/0.9.4) followed.
...
And last but not least - can you believe this? [Pidgin 2.14.0](https://pidgin.im/posts/2020-06-2.14.0-released/) 😯 There is also a [Twitch stream](https://twitter.com/rw_grim/status/1278857182629498880) every Thursday.

### Servers

The ignite realtime community released:
- [Openfire Beta 4.6.0](https://discourse.igniterealtime.org/t/openfire-4-6-0-beta-is-released/88203) - Highlights: XEP-0289: Federated MUC for Constrained Environments and improved PEP/PubSub support. If you have time to test please join them to help out!
...
Thanks to emus, mdosch, nyco, pmaziere, sualko, wurstsalat3000 for their help in creating it!
