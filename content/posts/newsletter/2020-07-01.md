...
JC Brand was so nice to create a [XMPP job board](https://xmpp.work/)! You are able to rewiew jobs offers as well as advertise XMPP services, too. Please take a look, post your own offers and recommend it. XMPP works!
...
The XMPP client Dino is one out of three projects which were awarded with the [10th Thomas Krenn Award](https://www.thomas-krenn.com/de/unternehmen/presse/pressemeldung.thomas-krenn-award-2020.html) (German).
...
Daniel Gultsch and Holger Weiss had a virtual talk on their A/V implementation in Conversation and describe the technical details. eta finalized the session with a second talk by defining love by this formula: Asterisk + XMPP = <3
...
[Gajim 1.2.0](https://gajim.org/post/2020-06-21-gajim-1.2.0-released/) has been released. More than a year after the release of Gajim 1.1.3 it is finally time for Gajim 1.2. A year of developing new features, cleaning up old code, and bug fixing. Highlights of this release are (amongst others): improved group chat system, completely rewritten network code, and a new account creation assistant. But there is much more to discover.

Profanity released its version 0.9.0 which supports Last Message Correction (XEP-0308) and fix various issues that can be found in their [blog post](https://profanity-im.github.io/blog/post/release-090/). After the new major release the bugfix releases [0.9.1](https://github.com/profanity-im/profanity/releases/tag/0.9.1), [0.9.2](https://github.com/profanity-im/profanity/releases/tag/0.9.2), [0.9.3](https://github.com/profanity-im/profanity/releases/tag/0.9.3) and [0.9.4](https://github.com/profanity-im/profanity/releases/tag/0.9.4) followed.

[JSXC](https://jsxc.org) released [version 4.1.1](https://github.com/jsxc/jsxc/releases/tag/v4.1.1) which fixes several video related issues and enhances the interoperability with Conversations.
...
Gajim’s XMPP library '[python-nbxmpp](https://dev.gajim.org/gajim/python-nbxmpp/-/tree/master)' had its 1.0 release. Being a friendly fork of the xmppy library back in the days, a lot has changed since then. A lot of work went into it, especially during the past year. If you’re interested, there is a simple example client included.
