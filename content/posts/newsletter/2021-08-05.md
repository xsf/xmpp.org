...
Profanity [0.11.0](https://github.com/profanity-im/profanity/releases/tag/0.11.0) is out, bringing 6 months of polishing to 0.10.0. This includes MAM support (still experimental), support for changing the password, abilities in MUCs like voice and registration, OMEMO trust mode, MUC-PMs in public channels, spam reporting, server contact discovery, and much more.

[Jan-Philipp Litza](https://github.com/jplitza) and [mortzu](https://github.com/mortzu) build a XMPP feed integration for the German official warning app NINA: [Find the Github repository here](https://github.com/mortzu/nina_xmpp). One can simply [add the bot and register coordinates of interest](https://github.com/mortzu/nina_xmpp/blob/master/README.md). May it never contact you!
...
No information reached us this month :-(
...
Therefore many thanks to COM8, emus, mattJ, Licaon_Kter, wurstsalat3000 for their support and help in creation, review and translation!
