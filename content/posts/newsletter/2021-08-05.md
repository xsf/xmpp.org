...
Jan-Philipp Litza and mortzu build a XMPP feed integration for the German official warning app NINA: (Find the Github repository here](https://github.com/mortzu/nina_xmpp). One can simply [add the bot and register coordinates of interest](https://github.com/mortzu/nina_xmpp/blob/master/README.md). May it never contact you!
