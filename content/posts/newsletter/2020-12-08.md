...
-   [Encryption for stateless file sharing](https://xmpp.org/extensions/inbox/esfs.html)
    -   This specification provides a protocol for sharing encrypted files using the stateless file sharing protocol (XEP-xxxx).

-   [Stateless file sharing](https://xmpp.org/extensions/inbox/sfs.html)
...
-   [Stickers](https://xmpp.org/extensions/inbox/stickers.html)
    -   This specification provides a protocol to send stickers and to create and share sticker packs.

-   [File metadata element](https://xmpp.org/extensions/inbox/file-metadata.html)
