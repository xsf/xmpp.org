...
Missed in last months issue, the folks at [cometchat](https://www.cometchat.com/) have blogged about XMPP's history, working architecture, stanzas and 
...
Any Turkish speakers reading the newsletter? We don't have a translation yet, but [Ged](https://fosstodon.org/@Ged) has just published an in-depth blog post about XMPP called [Hangi "Chat" Programı?](https://www.yunbere.kalfazade.com/post/hangi-chat-programi). In about 40 minutes it takes the reader through the story of the 
...
Image: https://gajim.org/img/news/workspaces-preview-1.png
...
Communiqué is a new XMPP client from the [Mellium Co-op](https://opencollective.com/mellium) team. It was [announced](https://opencollective.com/mellium/updates/introducing-communique) this month and presented at the XMPP Office Hours (TODO: add video link). The source code can be found [in the repository](https://github.com/mellium/xmpp/). It includes updates to the Mellium XMPP library as well as the new Communiqué instant messaging client (discussed more below). The biggest updates this month are MAM and ad-hoc commands support.

Image: https://opencollective-production.s3.us-west-1.amazonaws.com/85c589a0-f462-11eb-af6c-e7a0da2f7bbc.png
...
No XMPP library project updates have reached us... :-(
...
Therefore many thanks to [-----] for their support and help in creation, review and translation!
