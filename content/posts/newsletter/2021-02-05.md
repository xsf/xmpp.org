...
-   [Stanza Multiplexing](https://xmpp.org/extensions/inbox/mux.html)
    -   This spec provides a mechanism for multiplexing multiple virtual hosts over a single XMPP session.

-   [Automatic Trust Management (ATM)](https://xmpp.org/extensions/inbox/automatic-trust-management.html)
...
-   Version 0.4.0 of [XEP-0372](https://xmpp.org/extensions/xep-0372.html) (References)
    -   Specify that begin is inclusive, starts counting at zero, and that end is exclusive (Dijkstra-based convention) (gh/jcbrand)


-   Version 0.2.0 of [XEP-0434](https://xmpp.org/extensions/xep-0434.html) (Trust Messages (TM))
