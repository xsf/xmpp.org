...
Lorenz Kästle wrote an article on the setup for a [Icinga 2 system with an python3-slixmpp library](https://www.netways.de/blog/2020/08/28/zurueck-in-die-zukunft-icinga2-benachrichtigungen-mit-xmpp/). See the [reposity on Github](https://github.com/RincewindsHat/icinga2_xmpp-notifications), too.
...
[Kaidan 0.6.0 has been released](https://www.kaidan.im/2020/08/20/kaidan-0.6.0/)! The update includes stability fixes, a new offline message queue and an improved message correction. Furthermore, the upstream HTTP File Upload implementation of its XMPP library [QXmpp](https://github.com/qxmpp-project/qxmpp) is used now.
