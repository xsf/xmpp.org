---
title: Everyone go for decentralisation! 15 Mar 2020
save_as: tba
url: tba
...
In March there will be two XMPP Sprints in [Düsseldorf](https://wiki.xmpp.org/web/Sprints/2020_March_Duesseldorf) and [Berlin](https://wiki.xmpp.org/web/Sprints/2020_March_Berlin). Feel free to join and support the community and their work! Please stay informed about the Berlin Sprint due to the COVID-19 situation.''(And yes the Düsseldorf Sprint already happened!)''
...
## GSoC
[Google Summer of Code 2020 has been announced](https://summerofcode.withgoogle.com/organizations/5474262808264704/), some XMPP projects have already shown interest to mentor students.
...
_Due to the late publishing this is already over._
