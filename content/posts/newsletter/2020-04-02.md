...
yax.im updated their servers from prosody 0.11 to prosody-trunk. Read more about the changes [here](https://yaxim.org/blog/2020/04/23/new-prosody-on-yax-dot-im/).

And regarding the previous news - see here the changelog for [prosody-trunk](https://hg.prosody.im/trunk/file/d0e6d5bc7ea2/CHANGES). Highlights are:
