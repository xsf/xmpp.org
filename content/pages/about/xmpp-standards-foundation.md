...
- __Daniel Gultsch__ is the maintainer of the popular Android client [Conversations](https://conversations.im) and operates an [XMPP domain hosting service](https://account.conversations.im/domain). He has also (co-) created severals XEPs. Contact information can be found on [his website](https://gultsch.de).
