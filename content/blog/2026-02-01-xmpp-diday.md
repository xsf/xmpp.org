...
Besides other services, XMPP is listed as an [alternative chat option](https://di.day/whats-app-zu-signal/) and XMPP Community members have created so-called switch recipes on their own: [Digital Independence Day](https://imday.de/en/).
...
The DI.DAY is not a single event, it takes place every [first sunday of the month](https://termine.di.day/) so interested users can switch one service at a time.
