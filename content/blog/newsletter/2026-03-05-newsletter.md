...
- [XMPP material for DI.DAY](https://di-day.xmpp.link/): Four [recipes](https://imday.de/en/) to use an open chat protocol at the 'Digital Independence Day', the German ([DI.DAY](https://di.day/de)) initiative, from the [XMPP community](/2026/02/xmpp-listed-as-alternative-chat-at-di.day-initiative/) to enable people to start with independent messaging!
...
- [Help Movim Reach Its Goals for 2026](https://mov.im/community/pubsub.movim.eu/Movim/help-movim-reach-its-goals-for-2026-LQext9) by Timothée Jaussoin for the [Movim Blog](https://mov.im/community/pubsub.movim.eu/Movim).
