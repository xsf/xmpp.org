...
- La XSF sumó su [firma a la Carta Abierta a la Comisión Europea](https://xmpp.org/2024/08/the-xsf-signs-open-letter-to-the-european-commission/). Tal como muchas otras otras organizaciones lo están haciendo, la [XMPP Standards Foundation](https://xmpp.org/about/xmpp-standards-foundation/) (XSF) decidió sumar su firma a la  [Carta Abierta a la Comisión Europea](https://www.ow2.org/view/Events/The_European_Union_must_keep_funding_free_software_open_letter).
...
- [Monocles Chat 1.7.11](https://codeberg.org/monocles/monocles_chat/releases/tag/v1.7.11) publicó su última actualización. ¡Y trae una enorme lista de soluciones de errores, correcciones, actualizaciones, mejoras, cambios y ya se encuentra disponible en  [F-Droid](https://f-droid.org/)!.
...
- [Blasta](https://git.xmpp-it.net/sch/Blasta) ([mirror](https://www.f-hub.org/XMPP/Blasta)) es un sistema de marcadores (bookmarking system) federado, basado en XMPP, que hace posible compartir la colección de marcadores (también conocido como social bookmarking) almacenados en su cuenta XMPP, no solo entre su propio software, dispositivos y equipos, sino también, y en especial, con otras personas.
