...
summary: "In this issue: INCOMPLETE Read about the XMPP Summit 28 and Fosdem 26. Learn about XMPP and Metadata, XMPP integration with n8n, Independent Messaging Day: A recipe for digital freedom and sovereignty, Fluux Messenger and more. Update your clients with Conversations, Gajim, Monal, Monocles and Prose. Update your servers: Prosody, MoongooseIM 6.0.5, ejabberd. XEP’s news - a proposed XEP and an updated one!"
---
...
- [xmpp-dns](https://salsa.debian.org/mdosch/xmpp-dns/-/blob/master/README.md?ref_type=heads), a CLI tool to check XMPP SRV records, version [0.5.6](https://salsa.debian.org/mdosch/xmpp-dns/-/releases/v0.5.6), [0.6.0](https://salsa.debian.org/mdosch/xmpp-dns/-/releases/v0.6.0) and [0.6.1](https://salsa.debian.org/mdosch/xmpp-dns/-/releases/v0.6.1) have been released. Full details on the [changelog](https://salsa.debian.org/mdosch/xmpp-dns/-/blob/master/CHANGELOG.md?ref_type=heads).
